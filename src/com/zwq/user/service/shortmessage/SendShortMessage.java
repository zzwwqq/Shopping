package com.zwq.user.service.shortmessage;
...
public class SendShortMessage {
	...
	private static final String ACCOUNT_SID="c1717755b40b46f08b76ef1d4f8de4a4";
	private static final String AUTH_TOKEN="e09617941f78495f860a65e92c8e486d";
	
	
	//根据相应的手机号发送验证码
	public static String getCode(String phone,String loginpass){
		String rod=smsCode(loginpass);
		String timestamp=getTimestamp();
		String sig=getMD5(ACCOUNT_SID,AUTH_TOKEN,timestamp);
		String tamp="【文娱科技】您的博客登录密码为{"+rod+"}，请牢记您的密码，如非本人操作，请忽略此短信。";
...
//	}
	 ...
	 * @return
	 */
public static String smsCode(String findloginpass){
	String loginpass = findloginpass;
	return loginpass;
}	
}
